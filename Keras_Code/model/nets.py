...
class Net:
    ...
    def build_mwsnet_backbone(self, input_shape):
        ...
        M1 = self.net_blocks.separable_conv_block(M1, c[2], 3, s[2], activation=None)
        A2 = add([A1, M1, M2])
        ...
        M2 = self.net_blocks.separable_conv_block(M2, c[3], 3, s[3], activation=None)
        A3 = add([A2, M2, M3])
        ...
        M3 = self.net_blocks.separable_conv_block(M3, c[4], 3, s[4], activation=None)
        A4 = add([A3, M3, M4])
