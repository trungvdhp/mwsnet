...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model_name', type=str, default='mwsnet', help='The name of model need to train.')
        self.parser.add_argument('--start_fine_tune_layer_id', type=int, default=-4, help='The index of start fine tuning layer')
        self.parser.add_argument('--end_fine_tune_layer_id', type=int, default=-3, help='The index of end fine tuning layer')
